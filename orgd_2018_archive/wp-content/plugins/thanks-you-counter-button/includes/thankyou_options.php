...
if (isset($_GET['action']) && isset($_GET['success']) && $_GET['success']==1) {
  if ($_GET['action']=='default') {
    $mess = __('Default Settings are restored','thanks-you-counter-button');
  } else if ($_GET['action']=='resetall') {
    $mess = __('All Thanks Counters are cleared','thanks-you-counter-button');
  }
  if ($mess) {
...
<?php thanks_displayBoxStart(__('About this Plugin:', 'thanks-you-counter-button')); ?>
											<a class="thanks_rsb_link" style="background-image:url(<?php echo $shinephpFavIcon; ?>);" target="_blank" href="http://www.shinephp.com/"><?php _e("Author's website", 'thanks-you-counter-button'); ?></a>
											<a class="thanks_rsb_link" style="background-image:url(<?php echo THANKS_PLUGIN_URL.'/images/tycb.png'; ?>);" target="_blank" href="http://www.shinephp.com/thank-you-counter-button-wordpress-plugin/"><?php _e('Plugin webpage', 'thanks-you-counter-button'); ?></a>
											<a class="thanks_rsb_link" style="background-image:url(<?php echo THANKS_PLUGIN_URL.'/images/tycb_help.png'; ?>);" target="_blank" href="http://www.shinephp.com/thank-you-counter-button-wordpress-plugin/2/#filterhooks"><?php _e('Additional documentation', 'thanks-you-counter-button'); ?></a>
											<a class="thanks_rsb_link" style="background-image:url(<?php echo THANKS_PLUGIN_URL.'/images/tycb_changelog.png'; ?>);" target="_blank" href="http://www.shinephp.com/thank-you-counter-button-wordpress-plugin/2/#changelog"><?php _e('Changelog', 'thanks-you-counter-button'); ?></a>
											<a class="thanks_rsb_link" style="background-image:url(<?php echo THANKS_PLUGIN_URL.'/images/tycb_faq.png'; ?>);" target="_blank" href="http://www.shinephp.com/thank-you-counter-button-wordpress-plugin/2/#faq"><?php _e('FAQ', 'thanks-you-counter-button'); ?></a>                      
           <hr />
...
<script language="javascript" type="text/javascript">
  ...
  function thanks_Settings(action) {
    if (action=='cancel') {
      ...
      if (action=='default') {
        var mess = '<?php echo thanks_esc_js(__('All settings for TYCB plugin will be return to the default values, Continue?','thanks-you-counter-button')); ?>';
      } else if (action=='resetall') {
        var mess = '<?php echo thanks_esc_js(__('All thanks counters for all posts will be set to 0,\n all thanks click history will be cleared, Continue?','thanks-you-counter-button')); ?>';
      }
      if (!confirm(mess)) {
        return false;
      }
...
<div class="postbox" style="padding: 10px;">
  <h3><?php	_e('Display', 'thanks-you-counter-button'); ?></h3>
        <table class="form-table" style="clear:none;" cellpadding="0" cellspacing="0">          
          <tr>
            <th scope="row">
	             <?php _e('Display','thanks-you-counter-button'); ?>
            </th>
            <td>
                ...
                <label for="thanks_display_page"><?php _e('Display button at Pages','thanks-you-counter-button'); ?></label><br/>
                ...
                <label for="thanks_display_home"><?php _e('Display button at Home page, Categories/Tags archive pages','thanks-you-counter-button'); ?></label><br/>                
...
<?php _e('Do not show button for selected categories','thanks-you-counter-button');
...
?>
          ...
          <tr>
          <th scope="row">
            <?php _e('Position in the Post text', 'thanks-you-counter-button'); ?>
          </th>
          <td>
            <div>
              <span style="float: left; width: 140px;"><input type="checkbox" name="thanks_position_before" value="1" <?php echo thanks_optionChecked($thanks_position_before, 1); ?> onchange="checkBoxChange(this, 'thanks_position_firstpageonly');"/> <?php _e('Before', 'thanks-you-counter-button'); ?></span>
              <div id="thanks_position_firstpageonly" style="<?php echo ($thanks_position_before) ? 'visibility: visible;':'visibility: hidden'; ?>" >
                <input type="checkbox" name="thanks_position_firstpageonly" value="1" <?php echo thanks_optionChecked($thanks_position_firstpageonly, 1); ?> /> <?php _e('At first page of multipaged posts only', 'thanks-you-counter-button'); ?>
              </div>
            </div>
            <div>
              <span style="float: left; width: 140px;"><input type="checkbox" name="thanks_position_after" value="1" <?php echo thanks_optionChecked($thanks_position_after, 1); ?> onchange="checkBoxChange(this, 'thanks_position_lastpageonly');"/> <?php _e('After', 'thanks-you-counter-button'); ?></span>
              <div id="thanks_position_lastpageonly" style="<?php echo ($thanks_position_after) ? 'visibility: visible;':'visibility: hidden'; ?>" >
                <input type="checkbox" name="thanks_position_lastpageonly" id="thanks_position_lastpageonly" value="1" <?php echo thanks_optionChecked($thanks_position_lastpageonly, 1); ?> /> <?php _e('At last page of multipaged posts only', 'thanks-you-counter-button'); ?>
              </div>
            </div>
            <div>
              <input type="checkbox" name="thanks_position_shortcode" value="1" <?php echo thanks_optionChecked($thanks_position_shortcode, 1); ?> /> <?php _e('Shortcode [thankyou]','thanks-you-counter-button'); ?>
              <input type="checkbox" name="thanks_position_manual" value="1" <?php echo thanks_optionChecked($thanks_position_manual, 1); ?> /> <?php _e('Manual','thanks-you-counter-button'); ?>
            </div>
          </td>
        </tr>
        <tr>
          <th scope="row">
	           <label for="thanks_caption"><?php _e('Button Caption','thanks-you-counter-button'); ?></label>
          </th>
          <td>
        ...
        <tr>
          <th scope="row"><label for="thanks_style"><?php _e('Button Styling','thanks-you-counter-button'); ?></label></th>
          <td>
            <span class="setting-description" style="float: left; width: 150px;"><?php _e('Add style to the div:','thanks-you-counter-button');?></span>
            ...
            <div id="buttonDivStyleHelp" style="display: none;"><span class="setting-description"><?php _e('e.g.,','thanks-you-counter-button');?> <code>float: left; margin-right: 10px;</code></span></div>
            <span class="setting-description" style="float: left; width: 150px;"><?php _e('to the Caption font:','thanks-you-counter-button');?></span>
            ...
            <div id="buttonFontStyleHelp" style="display: none;"><span class="setting-description"><?php _e('e.g.,','thanks-you-counter-button');?><code>font-family: Sans-Serif; font-size: 14px; font-weight: normal;</code></span></div>
            <div><?php _e('font color: ','thanks-you-counter-button');?><input name="thanks_caption_color" id="thanks_caption_color" class="iColorPicker" value="<?php echo $thanks_caption_color; ?>" type="text" size="10" onchange="refreshButtonCaptionColor(this.value);"></div>
          </td>
        </tr>
        <tr>
          <th scope="row">
            <?php _e('Button grafics','thanks-you-counter-button'); ?>
          </th>
          <td>
            <span style="font-size: 12px;"><?php _e('Size','thanks-you-counter-button'); ?>:</span>  
              ...
              <label for="thanks_size_large"><?php _e('Normal','thanks-you-counter-button'); ?></label>&nbsp;
              ...
              <label for="thanks_size_compact"><?php _e('Compact','thanks-you-counter-button'); ?></label>
              <span style="margin-left:40px;font-size: 12px;"><?php _e('Form', 'thanks-you-counter-button'); ?>:</span>
              ...
              <label for="thanks_form_square"><?php _e('Square','thanks-you-counter-button'); ?></label>&nbsp;
              ...
              <label for="thanks_form_rounded"><?php _e('Rounded','thanks-you-counter-button'); ?></label>
          </td>
        </tr>

        <tr>
          <th scope="row">
            <?php _e('Color', 'thanks-you-counter-button'); ?>
          </th>
          <td>
...
?>
        ...
        <tr>
          <td>
            ...
            <?php _e('Custom button image URL', 'thanks-you-counter-button'); ?><br />
            <?php _e('Hover state image URL', 'thanks-you-counter-button'); ?>
          </td>
          <td>
            ...
            <div id="customButtonDivStyleHelp" style="display:none;"><?php _e('e.g.,','thanks-you-counter-button'); ?> <code>http://yourblog.com/wp-content/uploads/2009/10/your-button.png</code></div>
            <div>
              <span style="float:left; width:210px;"><?php _e('Width, px', 'thanks-you-counter-button'); ?> <input type="text" id="thanks_custom_width" name="thanks_custom_width" value="<?php echo $thanks_custom_width; ?>" size="4" onchange="refreshPreviewButton();" /></span>
              <span style="float:left; width:210px;"><?php _e('Height, px', 'thanks-you-counter-button'); ?> <input type="text" id="thanks_custom_height" name="thanks_custom_height" value="<?php echo $thanks_custom_height; ?>" size="4" onchange="refreshPreviewButton();" /></span>
            </div>            
          </td>
        </tr>
      </table>
  
<h3><?php _e('Button DIV Style Preview', 'thanks-you-counter-button'); $thanks_display_anchor = 1; ?></h3>
  ...
  echo '<div class="thanks_button_div" id="thanks_button_preview" style="'.$thanks_style.'">'.
      $inputButtonHTML.
   		'<div id="thanks_settings_shortcuts" class="thanks_settings_shortcuts'.(($thanks_display_settings_shortcuts == '1')?'':'_off').'">'.
 			'<a href="javascript:void;" title="'.__('Settings','thanks-you-counter-button').'"><img class="thanks_shortcuts" height="8" width="8" alt="thank_you_settings" src="'.THANKS_PLUGIN_URL.'/images/settings.png" /></a>'.
 			'<a href="javascript:void;" title="'.esc_attr(sprintf(__('View statistics details for "%s"', 'thanks-you-counter-button'), __('Post Title','thanks-you-counter-button'))).'"><img class="thanks_shortcuts" height="8" width="8" alt="thank_you_settings" src="'.THANKS_PLUGIN_URL.'/images/stats.png" /></a>'.
 			'<a title="'.__('Hide these shortcuts', 'thanks-you-counter-button').'" href="javascript:void;"><img class="thanks_shortcuts" height="8" width="8" alt="thank_you_settings" src="'.THANKS_PLUGIN_URL.'/images/disable.png" /></a>'.
 			'</div></div>';
?>
      ...
      <h3><?php _e('Miscellaneous:', 'thanks-you-counter-button'); ?></h3>
      <table class="form-table" style="clear:none;" cellpadding="0" cellspacing="0">
        <tr>
          <th scope="row">
              <?php _e('Check IP-address','thanks-you-counter-button'); ?>
          </th>
          <td>
            ...
            <label for="thanks_check_ip_address"><?php _e('Only one Thanks for post for one IP-address limit','thanks-you-counter-button'); ?></label><br/>
            <?php _e('Time limit:', 'thanks-you-counter-button'); ?>
            ...
            <?php _e('Forever','thanks-you-counter-button'); ?></label><br/>
            ...
            <?php _e('Only for this period','thanks-you-counter-button'); ?></label>            
          <input type="text" name="thanks_time_limit_seconds" id="thanks_time_limit_seconds" value="<?php echo $thanks_time_limit_seconds; ?>" size="10" />
            <?php _e('seconds', 'thanks-you-counter-button'); ?></div>
          </td>
        </tr>
        <tr>
          <th scope="row">
              <?php _e('Display settings shortcuts','thanks-you-counter-button'); ?>
          </th>
          <td>
            ...
            <label for="thanks_display_settings_shortcuts"><?php _e('Add shortcuts next to the buttons for settings quick access','thanks-you-counter-button'); ?></label>
          </td>
        </tr>
        </table>
      <div class="submit">
        <div style="float: left; ">
          <input type="submit" name="submit" value="<?php _e('Save Changes', 'thanks-you-counter-button'); ?>" title="<?php _e('Save Changes', 'thanks-you-counter-button'); ?>" />
          <input type="button" name="cancel" value="<?php _e('Cancel', 'thanks-you-counter-button') ?>" title="<?php _e('Cancel not saved changes', 'thanks-you-counter-button'); ?>" onclick="thanks_Settings('cancel');"/>
        </div>
        <div style="float: right; ">
          <input class="warning" type="button" name="default" value="<?php _e('Return to Defaults', 'thanks-you-counter-button') ?>" title="<?php _e('Restore the default values for all settings', 'thanks-you-counter-button'); ?>" onclick="thanks_Settings('default');"/>
          <input class="warning" type="button" name="reset" value="<?php _e('Reset Counters', 'thanks-you-counter-button') ?>" title="<?php _e('Reset all thanks counters for the all posts', 'thanks-you-counter-button'); ?>" onclick="thanks_Settings('resetall');"/>
        </div>             
      </div>
